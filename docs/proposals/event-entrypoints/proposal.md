...
前置条件：v0.2.8 baseline Issue、Phase 1: split protocol test and documentation ownership 与 Phase 1.5 Codex App canary（Issue #20）完成
...
4. [Event adapters and manifest 套件](../event-adapters-manifest/proposal.md)：单一 façade 路由、实现收缩，并重放 Phase 1.5 App canary。
